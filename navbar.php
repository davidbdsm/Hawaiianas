       ...
       <a href="index.php"> <img class="img-fluid" href="index.php" src="img/logo.png" /><br></a>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                ...
                <form class="  pesquisa form-inline my-2 my-lg-0 " method="post" action="index.php">
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Lojas Hawaianas</h1>
        <p class="lead text-muted mb-0">Lojas Hawaianas, o melhor lojão do Hawaii.</p>
    </div>
</section>
